...
export default function AstronomyDay() {
  ...
  useEffect(() => {
    async function fetchAPIData() {
      const NASA_KEY = "iYs2mla9q3YatFP5nwBseOo2phExhmJwao0bFVOj";
  ...
  return (
    <div className="bg-gray-500 flex flex-col space-y-4 px-5 py-8">
        ...
        <div className="grid laptop:grid-cols-2 gap-2 tablet:grid-cols-1 grid-flow-col-2 justify-stretch">
          ...
          <div className="flex align-top">
            <div className="flex rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800 flex-col align-top">
              <div className="bg-gray-200 flex h-full flex-col justify-start gap-4 p-6">
                ...
                <p className=" bg-gray-300 max-w-xl font-normal text-gray-700 dark:text-gray-400">
                  {data?.explanation}
                </p>
              </div>
            </div>
