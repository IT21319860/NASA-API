...
export default function Example() {
  return (
    ...
    <div className="bg-gray-800 pt-14 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="animate-bounce mx-auto max-w-2xl lg:text-center">
          {/* <h2 className="text-base font-semibold leading-7 text-indigo-600 text-center">Deploy faster</h2> */}
          <p className="mt-2 text-6xl font-bold tracking-tight text-gray-100 sm:text-4xl text-center">
